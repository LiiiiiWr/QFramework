...
//[CustomEditor(typeof(PTText))]
//public class PTTextInspactor : Editor {
//
//	string key = "";
...
//		GUILayout.BeginHorizontal();
//		GUILayout.Label("Key", GUILayout.Width(56f));
//
//		key =  GUILayout.TextField(key);
//
//		if (!string.Equals(key,serializedObject.FindProperty ("Key").stringValue)) {
