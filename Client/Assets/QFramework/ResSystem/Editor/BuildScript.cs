	...
	public class BuildScript
	{
		...
		public static List<string> PackZips(string outpath)
		{
			...
			foreach (var path in allDirs)
			{
				...
				if (QAssetBundleTool.HasQABLabel(obj, QAssetBundleTool.LABEL_ZIP))
				{
		...
		public static List<string> PackQFiles(string outpath)
		{
			...
			foreach (var k in allFiles)
			{
				...
				if (QAssetBundleTool.HasQABLabel(obj, QAssetBundleTool.LABEL_FILE))
				{
					files.Add(k);
		...
		public static void PackFiles(string filename, string directory)
		{
			try
			{
				if (Application.platform == RuntimePlatform.OSXEditor)
				{
					...
					string shell = Application.dataPath + "/QUGame/Framework/ResSystem/Editor/shell.sh";
		...
		private static void GenerateVersionConfig(string outputPath, List<string> finalZips, List<string> finalFiles)
		{
			...
			XmlElement filTiem = CreateConfigItem(xmlDoc,
				Application.streamingAssetsPath + FrameworkConfigData.RELATIVE_AB_ROOT_FOLDER +
		...
		static void CopyAssetBundlesTo(string outputPath)
		{
			...
			var source =
				Path.Combine(Path.Combine(System.Environment.CurrentDirectory, QAssetBundleTool.AssetBundlesOutputPath),
					outputFolder);
