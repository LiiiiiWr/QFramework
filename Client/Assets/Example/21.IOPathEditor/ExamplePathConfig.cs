...
namespace QFramework.Example
{
    ...
    public class ExamplePathConfig
    {
        ...
        {
            get { return IOUtils.CreateDirIfNotExists("Assets/" + m_ExampleEditorPathDir); }
        }
        ...
        public static string ExamplePersistentPathDir
        {
            get
            {
                return IOUtils.CreateDirIfNotExists(UnityEngine.Application.persistentDataPath + "/" +
                                                    m_ExamplePersistentPathDir);
            }
        }
    }
}