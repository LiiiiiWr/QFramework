...
namespace QFramework
{
    ...
    public partial class UIMgr : QMonoSingleton<UIMgr>
    {
        ...
        #region 字段
        private QEventSystem                 m_UIEventSystem = ObjectPool<QEventSystem>.Instance.Allocate();
        ...
        public QEventSystem uiEventSystem
        {
            get
            {
    ...
    where T : IConvertible
        ...
        private void ReSortPanel()
        {
            ...
            QEventSystem.Instance.Send(EngineEventID.OnPanelUpdate);
        }
